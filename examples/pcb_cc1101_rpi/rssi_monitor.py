...
while True:
    ...
    x = int((max_rssi_interval+120)/12)
    print(f"RSSI: {max_rssi_interval:>7} dBm "+str(x)+ f" (max: {max_rssi:>7} dBm): {'|'*int((max_rssi_interval+120)/2):<50}", end="\r")
    bus.write_byte(0x20, (0xFF-(0xFF80>>x))&0xFF)